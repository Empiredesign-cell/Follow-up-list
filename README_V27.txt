...
V27 FIX KARAKTER:
- 2 karakter PNG sekarang di-embed langsung ke index.html sebagai data URL.
- Tidak perlu upload avatar-kuning-topi.png / avatar-kuning-bulat.png lagi.
- Cukup replace index.html.
- Render tetap object-contain full body agar karakter tidak terpotong.
